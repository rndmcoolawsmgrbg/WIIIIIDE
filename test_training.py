...
def start_node(model, node_id, use_compression):
    ...
    def network_callback(sent_bytes, received_bytes, comp_time, net_time, original_size, compressed_size):
        stats.add_network_stats(node_id, sent_bytes, received_bytes, comp_time, net_time, original_size, compressed_size)
